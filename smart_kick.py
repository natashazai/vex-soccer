...
import time
import json
from goat_detection.fsm import *
...
class smart_kick(StateMachineProgram):
    ...
    def setup(self):
        ...
        CheckGoal = CheckGoal() .set_name("CheckGoal") .set_parent(self)
        
        completiontrans1 = CompletionTrans() .set_name("completiontrans1")
        completiontrans1 .add_sources(glow1) .add_destinations(loop)
        
        completiontrans2 = CompletionTrans() .set_name("completiontrans2")
        completiontrans2 .add_sources(loop) .add_destinations(team_lights)
        
        completiontrans3 = CompletionTrans() .set_name("completiontrans3")
        completiontrans3 .add_sources(team_lights) .add_destinations(find_goal)
        
        failuretrans1 = FailureTrans() .set_name("failuretrans1")
        failuretrans1 .add_sources(find_goal) .add_destinations(scan)
        
        successtrans1 = SuccessTrans() .set_name("successtrans1")
        successtrans1 .add_sources(find_goal) .add_destinations(find_ball)
        ...
        successtrans2 .add_sources(find_ball) .add_destinations(go_remembered)
        
        failuretrans2 = FailureTrans() .set_name("failuretrans2")
        failuretrans2 .add_sources(find_ball) .add_destinations(scan)
        ...
        completiontrans5 .add_sources(forward1) .add_destinations(loop)
        
        completiontrans6 = CompletionTrans() .set_name("completiontrans6")
        completiontrans6 .add_sources(charge) .add_destinations(get_dist)
        ...
        completiontrans7 .add_sources(forward2) .add_destinations(near_ball)
        
        completiontrans8 = CompletionTrans() .set_name("completiontrans8")
        completiontrans8 .add_sources(near_ball) .add_destinations(ask_gpt)
        ...
        completiontrans9 .add_sources(turn2) .add_destinations(do_kick)
        
        completiontrans10 = CompletionTrans() .set_name("completiontrans10")
        completiontrans10 .add_sources(aim_adjust) .add_destinations(do_kick)
        ...
        completiontrans11 .add_sources(turn3) .add_destinations(drive_around)
        
        completiontrans12 = CompletionTrans() .set_name("completiontrans12")
        completiontrans12 .add_sources(go_around) .add_destinations(do_kick)
        ...
        completiontrans13 .add_sources(forward3) .add_destinations(face_goal)
        ...
        completiontrans14 .add_sources(turn4) .add_destinations(charge_goal)
        
        completiontrans15 = CompletionTrans() .set_name("completiontrans15")
        completiontrans15 .add_sources(face_goal) .add_destinations(charge_goal)
        
        completiontrans16 = CompletionTrans() .set_name("completiontrans16")
        completiontrans16 .add_sources(charge_goal) .add_destinations(do_kick)
        
        completiontrans17 = CompletionTrans() .set_name("completiontrans17")
        completiontrans17 .add_sources(do_kick) .add_destinations(CheckGoal)
        
        failuretrans3 = FailureTrans() .set_name("failuretrans3")
        failuretrans3 .add_sources(CheckGoal) .add_destinations(loop)
        
        successtrans3 = SuccessTrans() .set_name("successtrans3")
        successtrans3 .add_sources(CheckGoal) .add_destinations(loop)
